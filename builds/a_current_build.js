 ...
 *  Single File concatenated by Grunt Concatenate on 05-05-2017
 */
/*
...
(function() {
  ...
  TSAG.E_Car = (function(superClass) {
    ...
    E_Car.prototype.addDistance = function(dist) {
      return this.total_distance += dist;
    };

    E_Car.prototype.addTime = function(dt) {
      return this.total_time += dt;
    };

    E_Car.prototype.getDistanceTravelled = function() {
      return this.total_distance;
    };

    E_Car.prototype.getTimeTravelled = function() {
...
(function() {
  TSAG.S_Lane = (function() {
    ...
    S_Lane.prototype.moveCars = function(dt) {
  ...
  TSAG.Mesh_Basic = (function(superClass) {
    ...
    Mesh_Basic.prototype.clone = function(params) {
      ...
      output.revertFillColor = function() {
        return this.children[0].material.color = TSAG.style.m_default_fill.color.clone();
      };
      return output;
    };
